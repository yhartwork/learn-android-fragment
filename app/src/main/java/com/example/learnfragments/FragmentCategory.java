...
public class FragmentCategory extends Fragment implements View.OnClickListener {
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.btn_sub_category) {
            FragmentDetailCategory mDetailCategoryFragment = new FragmentDetailCategory();

            Bundle mBundle = new Bundle();
            mBundle.putString(FragmentDetailCategory.EXTRA_NAME, "ini dikirim dengan bundle");
            ...
            */
            ...
            if (mFragmentManager != null) {
                mFragmentManager
                        .beginTransaction()
                        .replace(R.id.frame_container, mDetailCategoryFragment, FragmentDetailCategory.class.getSimpleName())
                        .addToBackStack(null)
                        .commit();
            }
        }
